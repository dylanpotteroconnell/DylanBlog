...
y_{t} &= Z_t^T \alpha_t + \epsilon_t, ~~~~~~ \epsilon_t &\sim N(0, H_t).
\end{align*}
Thus, while a classic time series might model the relationship between $y_t$ and $y_{t+1}$ directly, a *structural* time series model instead links them through some latent, unobserved state, $\alpha_t$, which evolves underneath underneath 
