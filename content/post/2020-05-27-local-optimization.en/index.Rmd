...
So, we follow the direction of steepest ascent, but what does that look like in practice? Our mountain range elevation challenge^[name this somehow?] provides a natural visualization. Imagine we are dealing with the simplest of all mountain ranges: a single hill. This one is perfectly round, for simplicitly, but we pretend we don't know that, and we can only see the local area around us. 
